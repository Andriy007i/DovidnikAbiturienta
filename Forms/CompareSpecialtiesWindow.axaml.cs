...
namespace Dovidnik_Abiturienta.Forms
{
    public partial class CompareSpecialtiesWindow : Window
    {
        ...
        private void BuildComparison(List<Specialty> specialties)
        {
            ...
            grid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto }); // Назва
            grid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto }); // Код
            grid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto }); // Денна форма
            grid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto }); // Заочна форма
            grid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto }); // Ціна
            grid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto }); // Галузь
            ...
            // Данные для первой специальности
            ...
            // Данные для второй специальности
